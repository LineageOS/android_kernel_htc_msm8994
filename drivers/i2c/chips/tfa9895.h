...
#define TFA9895_KERNEL_LOCK(size)    _IOW(TFA9887_IOCTL_MAGIC, TFA9895_KERNEL_LOCK_NR, (size))
#define TFA9895_KERNEL_LOCK_INIT(size)  _IOW(TFA9887_IOCTL_MAGIC, TFA9895_KERNEL_INIT_NR, (size))
